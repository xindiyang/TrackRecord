package com.example.codoon.myapplication.OfflineMap;
...
public class OfflineMapActivity extends Activity implements
	...
	private void init() {
		...
		// 顶部
		mDownloadText =  findViewById(R.id.download_list_text);
		mDownloadedText = findViewById(R.id.downloaded_list_text);

		mDownloadText.setOnClickListener(this);
		mDownloadedText.setOnClickListener(this);
		mBackImage =  findViewById(R.id.back_image_view);
		mBackImage.setOnClickListener(this);

		// view pager 用到了所有城市list和已下载城市list所有放在最后初始化
		mContentViewPage =  findViewById(R.id.content_viewpage);
	...
	public void initAllCityList() {
		...
		mAllOfflineMapList =  provinceContainer
